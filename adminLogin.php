...
<!-- navbar -->
        <nav id="nav" class="navbar navbar-expand-lg navbar-dark fixed-top">
            <div class="container-fluid">
                ...
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        <li class="nav-item">
                            <a href="adminReg.php" class="nav-link" aria-current="page"><img id="menuImg" class="img-fluid" src="BOOTSTRAP/bootstrap-icons-1.9.1/house-fill.svg">SIGNUP</a>
                        </li>

                        <li class="nav-item">
                            <a href="signin.php" class="nav-link active"><img id="menuImg" class="img-fluid" src="BOOTSTRAP/bootstrap-icons-1.9.1/person-fill.svg">SIGNIN</a>
                        </li>
        ...
        <div id="form-section" class="container-fluid">
            ...
            <form action="function.php?lgn=adminLogin" method="POST" class=" row g-3 form needs-validation" novalidate enctype="multipart/formm-data">
